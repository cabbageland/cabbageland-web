(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{id:`reading-room`,name:`Reading Room`,sign:`reading room`,x:10,y:32,w:18,h:18,accent:`#d2c18c`,district:`Northwest stacks`,mood:`quiet lantern windows and laddered shelves`,description:`A library lodge cut into the upper ridge, where essays, links, and dispatches feel like rooms you can enter.`,details:[`This is the clearest clawlibrary signal in the scene: a structure with gravity, warmth, and a reason to explore.`,`Its perch above the valley makes it read as a knowledge district instead of a floating navigation card.`,`A good follow-on route is posts, notes, reading lists, experiments, and other browsable cabinets.`]},{id:`story-hut`,name:`Music and Story Hut`,sign:`compose boredom`,x:11,y:67,w:18,h:16,accent:`#e08d47`,district:`Southwest creek bend`,mood:`fireside audio, reeds, and gramophone glow`,description:`A tucked-away hut for songs, spoken fragments, ambient loops, and story objects that make the village feel inhabited.`,details:[`Placing it in the lower creek bend makes it feel discovered rather than merely listed.`,`The warmer palette and circular roof silhouette separate it from the bookish and technical districts.`,`This zone can eventually hold soundtrack loops, voice notes, fiction snippets, and small narrative toys.`]},{id:`monument`,name:`Central Cabbage Monument`,sign:`cabbage core`,x:39,y:30,w:23,h:24,accent:`#98ff8e`,district:`Valley heart`,mood:`terraced stone, mist, and falling water`,description:`The identity anchor of Cabbageland: a ceremonial cabbage fountain where the whole map converges.`,details:[`This is the scene spine. The river, paths, and sightlines should all make the monument feel central and inevitable.`,`A monument works better than a normal hero because it gives the homepage memory and orientation.`,`The water and glow imply life, ecology, and ongoing activity even when the page is still.`]},{id:`nerd-farm`,name:`Nerd's Farm and Lab`,sign:`nerd's farm`,x:66,y:44,w:21,h:20,accent:`#8dcde3`,district:`Eastern glassworks`,mood:`greenhouse domes, monitors, and cultivated prototypes`,description:`A research quarter for code, systems, datasets, technical writeups, and strange cultivated projects.`,details:[`This needs to feel infrastructural, not decorative: the place where things are measured, grown, and iterated on.`,`The greenhouse language ties engineering work to cultivation instead of generic dashboard aesthetics.`,`A natural extension is repos, experiments, dashboards, field notes, and lab notebooks.`]},{id:`gallery`,name:`Gallery Ridge`,sign:`my world in xd`,x:80,y:68,w:16,h:15,accent:`#ffcf95`,district:`Southeast overlook`,mood:`framed windows, banners, and evening light`,description:`A ridge-top gallery for visual work, interfaces, concept art, worlds, and finished weirdness.`,details:[`Its raised overlook makes the district feel curated and public-facing rather than like another utility box.`,`This prevents the homepage from collapsing into pure tech theming by giving visual work equal spatial presence.`,`A later version could show rotating frames, exhibit posters, and preview windows from featured projects.`]}],t=`
...
`,r=document.querySelector(`#app`);r.innerHTML=`
  <div class="shell">
    <header class="topbar">
...
`;var i=document.querySelector(`#panel-title`),a=document.querySelector(`#panel-district`),o=document.querySelector(`#panel-mood`),s=document.querySelector(`#panel-description`),c=document.querySelector(`#panel-details`),l=Array.from(document.querySelectorAll(`.landmark`));function u(t){let n=e.find(e=>e.id===t);n&&(i.textContent=n.name,a.textContent=n.district,o.textContent=n.mood,s.textContent=n.description,c.innerHTML=n.details.map(e=>`<li>${e}</li>`).join(``),l.forEach(e=>{let n=e.dataset.landmark===t;e.classList.toggle(`active`,n),e.setAttribute(`aria-pressed`,String(n))}))}l.forEach(e=>{let t=e.dataset.landmark;t&&(e.addEventListener(`mouseenter`,()=>u(t)),e.addEventListener(`focus`,()=>u(t)),e.addEventListener(`click`,()=>u(t)))}),u(`monument`);